...
public class AddProduct extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        productBean.createProduct(prodName);
        ProductDetails product = productBean.findMaxId();
        productSpecificationBean.createProductSpecification(description, price, units, product.getId(), barcode);
