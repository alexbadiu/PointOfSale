...
public class EditProduct extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ProductSpecificationDetails productSpecification = productSpecificationBean.findById(productId);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int productSpecificationId = Integer.parseInt(request.getParameter("productSpecification_id"));
        int productId = Integer.parseInt(request.getParameter("product_id"));
        
        productBean.updateProduct(productId, prodName);
        productSpecificationBean.updateProductSpecification(productSpecificationId, description, price, units, productId, barcode);
