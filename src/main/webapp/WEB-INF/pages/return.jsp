<%-- 
    Document   : return
    Created on : Jan 8, 2019, 7:13:39 PM
    Author     : Alex
--%>
...
<t:pageTemplate pageTitle="Return Products">
    <h1>Return Products</h1>
    <form class="needs-validation" novalidate method="POST" action="${pageContext.request.contextPath}/AddReturn">
        <div class="row">
            <div class="col-md-3">
                <div class="row">
                    <div class="mb-10">
            ...
            <div class="col-md-9">
                ...
                <div class="row">
                    <div class="mb-10">
                        <button class="btn btn-primary btn-lg btn-block" type="submit" formaction="${pageContext.request.contextPath}/ProcessReturn">Submit return</button>
                    </div>
                </div>
            </div>
        </div>
